...
docker build -t "$REPO_BASE/users-service:$SHORT_SHA" -t "$REPO_BASE/users-service:latest" services/users
...
docker build -t "$REPO_BASE/books-service:$SHORT_SHA" -t "$REPO_BASE/books-service:latest" services/books
...
docker build -t "$REPO_BASE/borrow-service:$SHORT_SHA" -t "$REPO_BASE/borrow-service:latest" services/borrow
